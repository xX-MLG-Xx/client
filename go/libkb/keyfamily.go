...
// with an identify (the inactiveSenderType is unset in this case, because the
// identify will determine it). Otherwise the key is no longer active, and the
// sender type indicates why.
